...
// Constructor
void Freenove_ESP32_VK16K33::init(uint8_t addr)
{
  // orientation flags
  resetDirection();
...
// Constructor
void Freenove_ESP32_VK16K33::init(uint8_t addr, int sda, int scl)
{
  // orientation flags
  resetDirection();
 ...
 */
void Freenove_ESP32_VK16K33::setBrightness(uint8_t brightness)
{
 ...
 * Set the blink rate.
 */
void Freenove_ESP32_VK16K33::setBlink(uint8_t blink)
{
  Wire.beginTransmission(_i2c_addr);
 ...
 */
void Freenove_ESP32_VK16K33::resetDirection(void)
{
  _reversed = false;
  _vFlipped = false;
  _hFlipped = false;
 ...
 */
void Freenove_ESP32_VK16K33::reverse(void)
{
  _reversed = !_reversed;
}
 ...
 */
void Freenove_ESP32_VK16K33::flipVertical(void)
{
  _vFlipped = !_vFlipped;
}
 ...
 */
void Freenove_ESP32_VK16K33::flipHorizontal(void)
{
  _hFlipped = !_hFlipped;;
}
 ...
 */
void Freenove_ESP32_VK16K33::clear(void)
{  
 ...
 */
void Freenove_ESP32_VK16K33::setPixel(uint8_t row, uint8_t col, uint8_t val, bool rowDirection)
{
  // bounds checking
  col = col & 0x07;
  row = row & 0x0F;
 ...
 */
void Freenove_ESP32_VK16K33::setRow(uint8_t row, uint8_t value, bool rowDirection)
{
 ...
 */
void Freenove_ESP32_VK16K33::writeRow(uint8_t row)
{
  // flip vertically
  if (_hFlipped)
  {
 ...
 */
void Freenove_ESP32_VK16K33::show(void)
{
  Wire.beginTransmission(_i2c_addr);
 ...
 * show static array
 */
void Freenove_ESP32_VK16K33::showStaticArray(byte *array1, byte *array2)
{
    for (int i = 0; i < 8; i++)
 ...
 * show led matrix
 */
void Freenove_ESP32_VK16K33::showLedMatrix(byte array[8][8],int x_offset,int y_offset)
{
